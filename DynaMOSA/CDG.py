import pprint, configparser, os, json, re, copy
import numpy as np
...
class CompactNode():
    ...
    def show_CompactNode(self):
        """
        Prints all the information of the CompactNode.
        """
        print("Node_id: {}".format(self.node_id))
        print("\tstart_pc: {}".format(self.start_pc))
        print("\tend_pc: {}".format(self.end_pc))
        print("\tincoming node ids: {}".format(self.inc_node_ids))
        print("\toutgoing node ids: {}".format(self.outg_node_ids))
...
class CompactEdge():
    ...
    def show_CompactEdge(self):
        """
        Shows all information of the Edge.
        """
        print("Edge from {}, to {} with predicate {}".format(self.startNode_id, self.endNode_id, self.predicate.eval))
