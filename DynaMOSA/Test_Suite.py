import os, configparser, pickle, ast
from Test import *
from CDG import *
...
class TestSuite():
    ...
    def __init__(self, _SmartContract, _accounts, _deploying_accounts, _pop_size=50, _random=True, _tests=[], _max_method_calls=10, _min_method_calls=0):
        """
        ...
        if not _random:
            ...
            for i in range(_pop_size):
                tests = tests + [TestCase(_methodCalls = None, _random = True, SmartContract = _SmartContract, accounts = _accounts, deploying_accounts = _deploying_accounts, max_method_calls = _max_method_calls, min_method_calls = _min_method_calls)]
            self.tests = tests

    def show_tests(self, _top_n=None):
        """
